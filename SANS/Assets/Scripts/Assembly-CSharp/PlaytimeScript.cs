...
public class PlaytimeScript : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		...
		else
		{
			if (!this.jumpRopeStarted)
			{
				...
				sm.Add3DSubtitle("Ready, Go!", aud_Congrats.length, Color.red, base.transform);
			}
	...
	private void TargetPlayer()
	{
		...
		if (!this.playerSpotted)
		{
			...
			sm.Add3DSubtitle("Lets Play!", aud_LetsPlay.length, Color.red, base.transform);
		}
	}
	...
	public void Disappoint()
	{
		...
		sm.Add3DSubtitle("That makes me sad!", aud_Sad.length, Color.red, base.transform);
